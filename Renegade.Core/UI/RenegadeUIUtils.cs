// Copyright Lacyway All Rights Reserved
/*
using Diz.Utils;
...
{
    internal static class RenegadeUIUtils
    {
        ...
        public static GClass3107 ShowRenegadeMessage(this PreloaderUI preloaderUI, string header, string message,
            ErrorScreen.EButtonType buttonType, float waitingTime, Action acceptCallback, Action endTimeCallback)
        {
            ...
            {
                RenegadePlugin.Instance.RenegadeLogger.LogError("You are trying to show error screen from non-main thread!");
            ...
            return messageHandler.errorScreen.ShowRenegadeMessage(header, message, new Action(messageHandler.method_1), waitingTime, new Action(messageHandler.method_2), buttonType, true);
        }

        public static GClass3109 ShowRenegadeMessage(this ErrorScreen errorScreen, string title, string message,
